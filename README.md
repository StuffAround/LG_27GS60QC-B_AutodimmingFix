...
**Strictly Prohibited:** You may **not** bundle, integrate, or embed these profiles into any software, scripts, calibration tools, or firmware without express written permission moreover the use of the idea behind the fix (changing any kind display paramters via software or creating automatic color profile via softare that does similar things like my color profile) is forbidden to be used.

### 3. Attribution Required
If you share or mention this fix or the idea behind the fix on forums, YouTube, or social media, you **must** credit **Stuff_Around** and link back to this repository.
